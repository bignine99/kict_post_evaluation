...
FIELD_QUERY_MAP = {
    ...
    "form3_construction_type": {
        ...
        "category": "1. 건설공사 개요 | 공사개요",
        "label": "공사성격",
        "query": "이 건설공사의 '공사성격'을 판별하세요. ①신규 ②개보수·현대화 ③확장·증설 ④기타 중 하나. 판별 기준: 기존에 없던 시설을 새로 건설하는 공사(신축, 신설, 조성, 매립 등)면 '신규'입니다. 기존 시설을 고치거나 현대화하면 '개보수·현대화', 기존 시설을 확장하면 '확장·증설'입니다. 컨텍스트에서 명시적으로 찾을 수 없더라도 공사 내용으로 판별 가능합니다.",
    ...
    "form3_bid_method": {
        ...
        "label": "도급방법",
        "query": "이 공사의 도급방법은? ①단독 ②공동도급(공동이행방식) ③공동도급(분담이행방식) ④공동도급(주계약자관리방식) 중 해당하는 것을 선택하세요. 또한 입찰방식(종합심사/턴키/기술제안/대안 등)과 계약방식(제한경쟁/일반경쟁/지명경쟁/수의 등)도 함께 추출하세요.",
        "target_docs": ["건설사업관리보고서", "준공검사보고서"],
...
■ 민원 대응 노력 및 결과
- (해결을 위해 노력한 조치사항, 보상 협의, 처리 결과 등을 개조식으로 작성)""",
        "target_docs": ["건설사업관리보고서"],
        "output_schema": {},
        "extraction_type": "narrative",
        "target_length": 1500,
